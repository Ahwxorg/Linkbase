...
interface ShikijiTransformerContext {
...
export { type AnsiLanguage as A, type BuiltinLanguage as B, type CodeToHastOptions as C, type HtmlRendererOptionsCommon as D, type HtmlRendererOptions as E, FontStyle as F, type ThemedTokenScopeExplanation as G, type HighlighterGeneric as H, type IRawGrammar as I, type ThemedTokenExplanation as J, bundledThemes as K, type LanguageInput as L, type MaybeGetter as M, bundledLanguagesBase as N, bundledLanguagesAlias as O, type PlainTextLanguage as P, bundledLanguages as Q, type Root as R, type SpecialLanguage as S, type ThemedToken as T, type Element as U, type BuiltinTheme as a, type RequireKeys as b, type CodeToThemedTokensOptions as c, type CodeToTokensWithThemesOptions as d, type IGrammar as e, type Awaitable as f, type MaybeModule as g, type MaybeArray as h, type ThemeInput as i, type StringLiteralUnion as j, type ResolveBundleKey as k, loadWasm as l, type ShikiContext as m, type HighlighterCoreOptions as n, type BundledHighlighterOptions as o, type LanguageRegistration as p, type CodeToHastOptionsCommon as q, type CodeOptionsSingleTheme as r, type CodeOptionsMultipleThemes as s, type CodeOptionsThemes as t, type CodeOptionsMeta as u, type TransformerOptions as v, type ThemeRegistrationRaw as w, type ThemeRegistration as x, type ShikijiTransformerContext as y, type ShikijiTransformer as z };
